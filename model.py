...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def attention(query, key, value, mask, droput: nn.Dropout):
        ...
        output = attention_scores @ value  # (batch_size, h, seq_len, d_k)
...
class Encoder(nn.Module):
    """Encoder for transformer models."""
...
class DecoderBlock(nn.Module):
    ...
    def forward(self, x, encoder_output, src_mark, tgt_mask):
        ...
        x = self.residual_connections[1](x, lambda x: self.cross_attention_block(x, encoder_output, encoder_output, src_mark))
...
class Decoder(nn.Module):
    """Decoder for transformer models."""
...
# function to build a transformer model with given hyperparameters
